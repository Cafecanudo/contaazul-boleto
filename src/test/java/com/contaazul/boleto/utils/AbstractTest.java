package com.contaazul.boleto.utils;

import com.contaazul.boleto.BoletoApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.MOCK, classes = BoletoApplication.class)
